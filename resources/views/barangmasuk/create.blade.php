    ...
    <div class="container-fluid">
        <form method="POST" action="{{ route('barangmasuk.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control text-gray-100">
            </div>

            <div class="form-group">
                <label for="qty_masuk">Jumlah Masuk:</label>
                <input type="number" name="qty_masuk" id="qty_masuk" class="form-control text-gray-100">
            </div>
